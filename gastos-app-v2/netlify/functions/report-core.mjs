// Lógica compartida del resumen mensual. La usan tanto monthly-report.mjs (programada,
// corre sola el día 1 de cada mes) como test-monthly-report.mjs (para probar a mano).
import nodemailer from 'nodemailer'

export const MONTHS = ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']
export const ANITA_EMAIL = 'analiadattoma@gmail.com'
...
export async function runMonthlyReport() {
  ...
  return { monthName: MONTHS[prevM], year: prevY }
}
